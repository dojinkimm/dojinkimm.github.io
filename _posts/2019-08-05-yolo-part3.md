...
4. [Part 4 : Objectness 점수 thresholding과 non-maximum suppression(NMS)](https://dojinkimm.github.io/ml/2019/08/06/yolo-part4/)
...
이 것으로 Part3은 마무리가 됐다. Model이 만들어졌고 weights도 load되었기 때문에 이제 objects를 detect할 수 있게 됐다. 다음 [Part4](https://dojinkimm.github.io/ml/2019/08/06/yolo-part4/)에서는 objectness confidence thresholding과 non-maximum ssuppression으로 detections 하는 방법을 다룰 것이다. 
